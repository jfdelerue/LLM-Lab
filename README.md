...
Sous chaque résultat A, B et C, l'expander **Log exact des requêtes envoyées** montre l'URL, le modèle, le prompt, les options et l'heure de chaque appel. Pour ne pas saturer la page, les longues chaînes base64 des images sont remplacées dans l'affichage par leur taille et leur empreinte SHA-256.
